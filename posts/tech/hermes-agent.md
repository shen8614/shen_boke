...
hermes config set deepseek.api_key sk-xxxxxxxxxxxx
```
...
hermes config set openrouter.api_key sk-or-v1-xxxxxxxxxxxx
```
...
hermes config set anthropic.api_key sk-ant-api03-xxxxxxxxxxxx
```
